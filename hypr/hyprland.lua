...
--   hl.exec_cmd("nm-applet")
  ...
  hl.exec_cmd("mpvpaper --auto-stop --auto-mode ACTIVE -o '--loop-file=inf' '*' /usr/share/sddm/themes/pixel-night-city/bg.mp4")
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(d8c7faee)", "rgba(af8cf2ee)"}, angle = 45 },
...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("pkill wofi || wofi --show run"))
...
hl.window_rule({
    match = { title = ".*[Oo]pen.*[Ff]older.*" },
    float = true,
    center = true,
})
hl.window_rule({
    match = { title = ".*[Oo]pen.*[Ff]ile.*" },
    float = true,
    center = true,
})
hl.window_rule({
